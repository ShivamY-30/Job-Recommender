...
def about_us():
    ...
    st.write("Contact us: yadavshivamp90671@gmail.com")
    st.divider()
    st.divider()
...
st.write('Job recommendation system')
st.divider()
            ...
            for col in row:
                if element_counter < num_elements:
                    ...
                    col.write(
                        ...
                        f'<div style="height: 160px; margin-bottom:20px; overflow:scroll;  width: 100%; box-shadow:2px 2px 3px grey; padding:10px 10px; margin: 5px; border-radius:8px";>Job Title/Position : {recomendations[element_counter]} <br>Job Description : {result_str}...</div>',
                        unsafe_allow_html=True
                    )
                    element_counter += 1
    except IndexError:
        st.write(
            "⚠️ Sorry At current time we are not having enough Information regarding your inputs, to suggest you your desired output! Please try again later ")
